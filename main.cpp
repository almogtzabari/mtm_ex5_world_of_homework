...
//    ASSERT_THROW(g3.addWarrior("Jerry", "Sword", LEVEL, 5, false);, mtm::NameAlreadyExists);
    ASSERT_THROW(g3.addWarrior("Elaine", "Sword", LEVEL, 5, false);, mtm::GameFull);

    Game g4(100);
    g4.addWarrior("Jerry", "Sword", LIFE, 3, true);
    g4.addWizard("George", "Staff", LEVEL, 4, 3);
    g4.addTroll("Kramer", "Club", STRENGTH, 3, 5);
    ASSERT_THROW(g4.addWarrior("Jerry", "Sword", LEVEL, 5, false);, mtm::NameAlreadyExists);
...
//    ASSERT_THROW(g5.addWarrior("Kramer", "Sword", LEVEL, 5, false);, mtm::NameAlreadyExists);
    ASSERT_THROW(g5.addWarrior("Newman", "Sword", LEVEL, 5, false);, mtm::GameFull);
    g5.makeStep("Kramer");
